...
pub use frame::{
    ...
    FrameExifEntry, FrameExifGpsAltitudeRef, FrameExifGpsDirectionRef, FrameExifGpsDistanceRef,
    FrameExifGpsLatitudeRef, FrameExifGpsLongitudeRef, FrameExifGpsSpeedRef, FrameExifIfd,
    FrameExifIfdPointerKind, FrameExifLinkedIfd, FrameExifOrientation, FrameExifRational,
    FrameExifResolutionUnit, FrameExifSignedRational, FrameExifTiffType, FrameFilmGrainAomParams,
