...
pub use frame::{
    ...
    FrameExifMeteringMode, FrameExifOrientation, FrameExifPhotometricInterpretation,
    FrameExifPlanarConfiguration, FrameExifRational, FrameExifResolutionUnit, FrameExifSaturation,
