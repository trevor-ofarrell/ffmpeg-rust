...
pub use frame::{
    ...
    FrameDynamicHdrPlus, FrameDynamicHdrVivid, FrameExif, FrameExifCommonTags, FrameExifEndian,
    FrameExifEntry, FrameExifGpsAltitudeRef, FrameExifGpsDirectionRef, FrameExifGpsLatitudeRef,
    FrameExifGpsLongitudeRef, FrameExifGpsSpeedRef, FrameExifIfd, FrameExifIfdPointerKind,
    FrameExifLinkedIfd, FrameExifOrientation, FrameExifRational, FrameExifResolutionUnit,
    FrameExifSignedRational, FrameExifTiffType, FrameFilmGrainAomParams, FrameFilmGrainH274Params,
