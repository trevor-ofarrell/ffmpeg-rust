...
pub use frame::{
    ...
    FrameExifEntry, FrameExifGpsAltitudeRef, FrameExifGpsLatitudeRef, FrameExifGpsLongitudeRef,
    FrameExifIfd, FrameExifIfdPointerKind, FrameExifLinkedIfd, FrameExifOrientation,
    FrameExifRational, FrameExifResolutionUnit, FrameExifSignedRational, FrameExifTiffType,
