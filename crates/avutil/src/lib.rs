...
pub use frame::{
    ...
    FrameDynamicHdrPlus, FrameDynamicHdrVivid, FrameExif, FrameExifEndian, FrameExifEntry,
    FrameExifIfd, FrameExifIfdPointerKind, FrameExifLinkedIfd, FrameExifRational,
