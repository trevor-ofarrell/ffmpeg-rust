...
pub use frame::{
    ...
    FrameAmbientViewingEnvironment, FrameAudioServiceType, FrameContentLightMetadata, FrameCrop,
    FrameData, FrameDetectionBbox, FrameDetectionBboxes, FrameDisplayMatrix,
