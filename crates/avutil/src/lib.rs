...
pub use frame::{
    ...
    FrameExifFlash, FrameExifGainControl, FrameExifGpsAltitudeRef, FrameExifGpsDirectionRef,
    ...
    FrameExifTiffType, FrameExifWhiteBalance, FrameFilmGrainAomParams, FrameFilmGrainH274Params,
