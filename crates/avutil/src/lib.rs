...
pub use frame::{
    frame_side_data_name_for_value, AudioFrame, Frame, FrameA53ClosedCaptions,
    FrameActiveFormatDescription, FrameAlphaMode, FrameAmbientViewingEnvironment,
    FrameAudioServiceType, FrameBufferTopology, FrameChromaLocation, FrameColorPrimaries,
    FrameColorRange, FrameColorSpace, FrameColorTransferCharacteristic, FrameContentLightMetadata,
    FrameCrop, FrameCropFlags, FrameData, FrameDecodeErrorFlags, FrameDetectionBbox,
    FrameDetectionBboxes, FrameDisplayMatrix, FrameDolbyVisionColorMetadata,
    ...
    FrameFilmGrainParams, FrameFilmGrainParamsType, FrameFlags, FrameGopTimecode,
