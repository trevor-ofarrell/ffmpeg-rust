...
pub use hash::{
    adler32, crc32_ieee, digest_to_hex, md5, murmur3, murmur3_seeded, sha1, sha224, sha256, sha384,
    sha512, sha512_224, sha512_256, Adler32, Crc32, Md5, Murmur3, Sha1, Sha224, Sha256, Sha384,
