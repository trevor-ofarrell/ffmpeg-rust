...
pub use frame::{
    ...
    FrameExifEntry, FrameExifExposureProgram, FrameExifFlash, FrameExifGpsAltitudeRef,
    ...
    FrameExifMeteringMode, FrameExifOrientation, FrameExifRational, FrameExifResolutionUnit,
    FrameExifSignedRational, FrameExifTiffType, FrameExifWhiteBalance, FrameFilmGrainAomParams,
