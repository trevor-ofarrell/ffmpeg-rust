...
pub use frame::{
    ...
    FrameColorTransferCharacteristic, FrameContentLightMetadata, FrameCrop, FrameData,
    FrameDecodeErrorFlags, FrameDetectionBbox, FrameDetectionBboxes, FrameDisplayMatrix,
