...
pub use frame::{
    ...
    FrameContentLightMetadata, FrameCrop, FrameData, FrameDetectionBbox, FrameDetectionBboxes,
    ...
    FrameDynamicHdrVivid, FrameExif, FrameExifBitsPerSample, FrameExifColorSpace,
    FrameExifCommonTags, FrameExifCompositeImage, FrameExifCompression, FrameExifContrast,
    FrameExifCustomRendered, FrameExifEndian, FrameExifEntry, FrameExifExposureMode,
    FrameExifExposureProgram, FrameExifFileSource, FrameExifFillOrder, FrameExifFlash,
