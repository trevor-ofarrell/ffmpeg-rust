...
pub use frame::{
    ...
    FrameDynamicHdrPlus, FrameDynamicHdrVivid, FrameExif, FrameExifColorSpace, FrameExifCommonTags,
    FrameExifCompositeImage, FrameExifCompression, FrameExifContrast, FrameExifCustomRendered,
    FrameExifEndian, FrameExifEntry, FrameExifExposureMode, FrameExifExposureProgram,
    FrameExifFileSource, FrameExifFillOrder, FrameExifFlash, FrameExifGainControl,
    FrameExifGpsAltitudeRef, FrameExifGpsDifferential, FrameExifGpsDirectionRef,
    FrameExifGpsDistanceRef, FrameExifGpsLatitudeRef, FrameExifGpsLongitudeRef,
    FrameExifGpsMeasureMode, FrameExifGpsSpeedRef, FrameExifGpsStatus, FrameExifIfd,
    FrameExifIfdPointerKind, FrameExifLightSource, FrameExifLinkedIfd, FrameExifMeteringMode,
    ...
    FrameExifSignedRational, FrameExifSubjectArea, FrameExifSubjectDistanceRange,
    FrameExifTiffType, FrameExifWhiteBalance, FrameExifYcbCrPositioning, FrameFilmGrainAomParams,
