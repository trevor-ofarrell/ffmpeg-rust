...
pub use frame::{
    ...
    FrameExifPhotometricInterpretation, FrameExifPlanarConfiguration, FrameExifRational,
    FrameExifResolutionUnit, FrameExifSaturation, FrameExifSceneCaptureType, FrameExifSceneType,
    FrameExifSensingMethod, FrameExifSensitivityType, FrameExifSharpness, FrameExifSignedRational,
    FrameExifSubfileType, FrameExifSubjectArea, FrameExifSubjectDistanceRange,
