...
impl PixelFormat {
    ...
    pub fn plane_sizes(self, width: usize, height: usize) -> AvResult<Vec<usize>> {
        ...
        match self {
            ...
            Self::Gbrp9Le | Self::Gbrp9Be => {
                let plane = checked_mul(pixels, 2, "9-bit planar GBR pixel format plane size")?;
...
mod tests {
    ...
    fn pixel_formats_report_ffmpeg_names_and_layout() {
        ...
        assert_eq!(PixelFormat::ALL.len(), 39);
    ...
    fn pixel_formats_report_descriptor_metadata() {
        ...
        for (format, name) in [
            ...
            assert_eq!(descriptor.bits_per_component, 9);
            assert_eq!(descriptor.bits_per_pixel, 27);
