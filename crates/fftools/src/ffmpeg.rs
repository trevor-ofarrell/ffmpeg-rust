...
mod tests {
    ...
    #[test]
    fn runs_rawvideo_nv20le_to_null_stdout() {
        let payload = (0_u8..48).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-nv20le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        assert_eq!(output.output_format(), Some("null"));
        assert_eq!(output.packet_count(), 1);
        assert_eq!(output.byte_count(), 48);
        assert!(output.stdout().is_empty());
        assert!(output.stderr().is_empty());
    }

    #[test]
    fn runs_rawvideo_p010le_to_null_stdout() {
        let payload = (0_u8..24).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-p010le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
    ...
    #[test]
    fn runs_rawvideo_y210le_to_null_stdout() {
        let payload = (0_u8..16).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-y210le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo y210le command path should execute");
    ...
    fn runs_rawvideo_ayuv64le_to_null_stdout() {
        ...
        .expect("rawvideo ayuv64le null path should execute");
    ...
    #[test]
    fn runs_rawvideo_xyz12le_to_null_stdout() {
        let payload = (0_u8..12).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-xyz12le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo xyz12le null path should execute");
    ...
    #[test]
    fn runs_rawvideo_xv30le_to_null_stdout() {
        let payload = (0_u8..16).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-xv30le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo xv30le null path should execute");
    ...
    #[test]
    fn runs_rawvideo_bayer_bggr8_to_null_stdout() {
        let payload = (0_u8..4).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-bayer-bggr8-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo bayer_bggr8 null path should execute");
    ...
    fn runs_rawvideo_yuv420p9le_to_null_stdout() {
        ...
        .expect("rawvideo yuv420p9le command path should execute");
    ...
    #[test]
    fn runs_rawvideo_yuv420p14le_to_null_stdout() {
        let payload = (0_u8..24).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-yuv420p14le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo yuv420p14le command path should execute");
    ...
    #[test]
    fn runs_rawvideo_gbrp10msble_to_null_stdout() {
        let payload = (0_u8..24).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-gbrp10msble-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo gbrp10msble command path should execute");
    ...
    #[test]
    fn runs_rawvideo_rgbf32le_to_null_stdout() {
        let payload = (0_u8..24).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-rgbf32le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo rgbf32le command path should execute");
    ...
    #[test]
    fn runs_rawvideo_rgbaf32le_to_null_stdout() {
        let payload = (0_u8..32).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-rgbaf32le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo rgbaf32le command path should execute");
    ...
    #[test]
    fn runs_rawvideo_rgba128le_to_null_stdout() {
        let payload = (0_u8..32).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-rgba128le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo rgba128le command path should execute");
    ...
    #[test]
    fn runs_rawvideo_yuv440p10le_to_null_stdout() {
        let payload = (0_u8..24).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-yuv440p10le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo yuv440p10le command path should execute");
    ...
    #[test]
    fn runs_rawvideo_yuva420p_to_null_stdout() {
        let payload = (0_u8..20).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-yuva420p-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo yuva420p command path should execute");

        let _ = fs::remove_file(&path);

        assert_eq!(output.output_format(), Some("null"));
        assert_eq!(output.packet_count(), 1);
        assert_eq!(output.byte_count(), 20);
        assert!(output.stdout().is_empty());
        assert!(output.stderr().is_empty());
    }

    #[test]
    fn runs_rawvideo_yuva420p10le_to_null_stdout() {
        let payload = (0_u8..40).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-yuva420p10le-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo yuva420p10le command path should execute");

        let _ = fs::remove_file(&path);

        assert_eq!(output.output_format(), Some("null"));
        assert_eq!(output.packet_count(), 1);
        assert_eq!(output.byte_count(), 40);
        assert!(output.stdout().is_empty());
        assert!(output.stderr().is_empty());
    }
    ...
    #[test]
    fn runs_rawvideo_vuya_to_null_stdout() {
        let payload = (0_u8..16).collect::<Vec<_>>();
        let path = write_temp_bytes("rawvideo-vuya-null", "raw", &payload);
        let path_arg = path.to_string_lossy().into_owned();
        ...
        .expect("rawvideo vuya command path should execute");
