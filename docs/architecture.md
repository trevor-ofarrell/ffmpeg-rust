...
- `crates/fate-runner`: FATE mapping and execution front end. It can list ledger components and select changed ledger components from git paths using explicit path rules for the currently mapped Rust modules; actual FATE execution remains blocked until samples and component command mappings exist.
