...
The `avutil-channel-layout` slice was checked against pinned FFmpeg 8.1.1 `libavutil/channel_layout.h` and `libavutil/channel_layout.c`. The pinned header defines `AV_CHAN_FRONT_LEFT_OF_CENTER`, `AV_CHAN_FRONT_RIGHT_OF_CENTER`, and `AV_CHAN_BACK_CENTER` after `AV_CHAN_BACK_RIGHT`, maps `AV_CH_FRONT_LEFT_OF_CENTER`, `AV_CH_FRONT_RIGHT_OF_CENTER`, and `AV_CH_BACK_CENTER` to their native mask bits, and defines the currently modeled native-mask layouts including `AV_CH_LAYOUT_2POINT1`, `AV_CH_LAYOUT_SURROUND`, `AV_CH_LAYOUT_2_1`, `AV_CH_LAYOUT_4POINT0`, `AV_CH_LAYOUT_2_2`, `AV_CH_LAYOUT_3POINT1`, `AV_CH_LAYOUT_5POINT0_BACK`, `AV_CH_LAYOUT_5POINT0`, `AV_CH_LAYOUT_4POINT1`, `AV_CH_LAYOUT_6POINT0`, `AV_CH_LAYOUT_6POINT0_FRONT`, `AV_CH_LAYOUT_HEXAGONAL`, `AV_CH_LAYOUT_6POINT1`, `AV_CH_LAYOUT_6POINT1_BACK`, `AV_CH_LAYOUT_6POINT1_FRONT`, `AV_CH_LAYOUT_7POINT0`, and `AV_CH_LAYOUT_7POINT0_FRONT`. The pinned `channel_layout_map` names those layouts `2.1`, `3.0`, `3.0(back)`, `4.0`, `quad(side)`, `3.1`, `5.0`, `5.0(side)`, `4.1`, `6.0`, `6.0(front)`, `hexagonal`, `6.1`, `6.1(back)`, `6.1(front)`, `7.0`, and `7.0(front)`, and `av_channel_layout_default` selects the first map entry with the requested channel count. The Rust model exposes those source-checked shapes and now models default counts 1, 2, 3, 4, 5, 6, 7, and 8 as mono, stereo, 2.1, 4.0, 5.0, 5.1, 6.1, and 7.1, while leaving custom/ambisonic orders and the remaining `ffmpeg -layouts` inventory for later oracle-backed slices.
