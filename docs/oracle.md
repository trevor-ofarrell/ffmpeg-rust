...
The `avutil-channel-layout` slice was checked against pinned FFmpeg 8.1.1 `libavutil/channel_layout.h` and `libavutil/channel_layout.c`. The pinned header defines `AV_CHAN_FRONT_LEFT_OF_CENTER`, `AV_CHAN_FRONT_RIGHT_OF_CENTER`, and `AV_CHAN_BACK_CENTER` after `AV_CHAN_BACK_RIGHT`, plus height/LFE enum entries including `AV_CHAN_TOP_FRONT_LEFT`, `AV_CHAN_TOP_FRONT_CENTER`, `AV_CHAN_TOP_FRONT_RIGHT`, `AV_CHAN_TOP_BACK_LEFT`, `AV_CHAN_TOP_BACK_CENTER`, `AV_CHAN_TOP_BACK_RIGHT`, `AV_CHAN_WIDE_LEFT`, `AV_CHAN_WIDE_RIGHT`, `AV_CHAN_LOW_FREQUENCY_2`, `AV_CHAN_TOP_SIDE_LEFT`, and `AV_CHAN_TOP_SIDE_RIGHT`; it maps `AV_CH_FRONT_LEFT_OF_CENTER`, `AV_CH_FRONT_RIGHT_OF_CENTER`, `AV_CH_BACK_CENTER`, `AV_CH_TOP_FRONT_LEFT`, `AV_CH_TOP_FRONT_CENTER`, `AV_CH_TOP_FRONT_RIGHT`, `AV_CH_TOP_BACK_LEFT`, `AV_CH_TOP_BACK_CENTER`, `AV_CH_TOP_BACK_RIGHT`, `AV_CH_WIDE_LEFT`, `AV_CH_WIDE_RIGHT`, `AV_CH_LOW_FREQUENCY_2`, `AV_CH_TOP_SIDE_LEFT`, and `AV_CH_TOP_SIDE_RIGHT` to their native mask bits, and defines the currently modeled native-mask layouts including `AV_CH_LAYOUT_2POINT1`, `AV_CH_LAYOUT_SURROUND`, `AV_CH_LAYOUT_2_1`, `AV_CH_LAYOUT_4POINT0`, `AV_CH_LAYOUT_2_2`, `AV_CH_LAYOUT_3POINT1`, `AV_CH_LAYOUT_5POINT0_BACK`, `AV_CH_LAYOUT_5POINT0`, `AV_CH_LAYOUT_4POINT1`, `AV_CH_LAYOUT_6POINT0`, `AV_CH_LAYOUT_6POINT0_FRONT`, `AV_CH_LAYOUT_HEXAGONAL`, `AV_CH_LAYOUT_6POINT1`, `AV_CH_LAYOUT_6POINT1_BACK`, `AV_CH_LAYOUT_6POINT1_FRONT`, `AV_CH_LAYOUT_7POINT0`, `AV_CH_LAYOUT_7POINT0_FRONT`, `AV_CH_LAYOUT_7POINT1`, `AV_CH_LAYOUT_7POINT1_WIDE`, `AV_CH_LAYOUT_7POINT1_WIDE_BACK`, `AV_CH_LAYOUT_5POINT1POINT2`, `AV_CH_LAYOUT_5POINT1POINT2_BACK`, `AV_CH_LAYOUT_OCTAGONAL`, `AV_CH_LAYOUT_CUBE`, `AV_CH_LAYOUT_5POINT1POINT4_BACK`, `AV_CH_LAYOUT_7POINT1POINT2`, `AV_CH_LAYOUT_7POINT1POINT4_BACK`, `AV_CH_LAYOUT_7POINT2POINT3`, `AV_CH_LAYOUT_9POINT1POINT4_BACK`, `AV_CH_LAYOUT_9POINT1POINT6`, and `AV_CH_LAYOUT_HEXADECAGONAL`. The pinned `channel_layout_map` names those layouts `2.1`, `3.0`, `3.0(back)`, `4.0`, `quad(side)`, `3.1`, `5.0`, `5.0(side)`, `4.1`, `6.0`, `6.0(front)`, `hexagonal`, `6.1`, `6.1(back)`, `6.1(front)`, `7.0`, `7.0(front)`, `7.1`, `7.1(wide)`, `7.1(wide-side)`, `5.1.2`, `5.1.2(back)`, `octagonal`, `cube`, `5.1.4`, `7.1.2`, `7.1.4`, `7.2.3`, `9.1.4`, `9.1.6`, and `hexadecagonal`, with `7.1(wide)` mapped to `AV_CH_LAYOUT_7POINT1_WIDE_BACK`, `7.1(wide-side)` mapped to `AV_CH_LAYOUT_7POINT1_WIDE`, `octagonal` mapped to an eight-channel non-LFE mask, `cube` mapped to quad plus top-front/top-back corner speakers, `5.1.4` mapped to `AV_CH_LAYOUT_5POINT1POINT4_BACK`, `7.1.2` mapped to `AV_CH_LAYOUT_7POINT1POINT2`, `7.1.4` mapped to `AV_CH_LAYOUT_7POINT1POINT4_BACK`, `7.2.3` mapped to `AV_CH_LAYOUT_7POINT2POINT3`, `9.1.4` mapped to `AV_CH_LAYOUT_9POINT1POINT4_BACK`, `9.1.6` mapped to `AV_CH_LAYOUT_9POINT1POINT6`, and `hexadecagonal` mapped to `AV_CH_LAYOUT_HEXADECAGONAL`. `av_channel_layout_default` selects the first map entry with the requested channel count. The Rust model exposes those source-checked shapes and models default counts 1, 2, 3, 4, 5, 6, 7, and 8 as mono, stereo, 2.1, 4.0, 5.0, 5.1, 6.1, and 7.1, while leaving binaural, downmix, `22.2`, broader height-channel, custom, ambisonic, and the remaining `ffmpeg -layouts` inventory for later oracle-backed slices.
