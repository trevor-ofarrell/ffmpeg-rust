...
use avutil::{
    ...
    FrameExifGpsLatitudeRef, FrameExifGpsLongitudeRef, FrameExifIfdPointerKind,
    FrameExifOrientation, FrameExifResolutionUnit, FrameExifTiffType, FrameFilmGrainAomParams,
