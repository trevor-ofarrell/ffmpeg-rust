...
- `avformat_packet_muxers`: exercises null/hash/framecrc/framehash/framemd5/streamhash packet muxer accounting, Adler-32/CRC-32/MD5/SHA-224/SHA-256/SHA-384/SHA-512 hash digest stability, FFmpeg framecrc checksums, per-packet hash, and per-stream hash record fields, timestamp propagation, and finish behavior.
