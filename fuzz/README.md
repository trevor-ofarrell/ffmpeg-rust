...
- `avutil_metadata_options`: exercises metadata dictionary mutation, duplicate-key insertion, key/value validation, AVOption-like definition validation, option flag truncation, read-only mutation rejection, string parsing, type/range checks, and failed-mutation invariants.
