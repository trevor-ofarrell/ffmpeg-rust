...
1. Continue priority-1 format-model work by adding the next narrow `PixelFormat` inventory slice needed by rawvideo parity, likely packed 16-bit RGB/BGR layout variants such as RGB555/RGB565/RGB444 families after re-checking pinned FFmpeg 8.1.1 headers/descriptors.
