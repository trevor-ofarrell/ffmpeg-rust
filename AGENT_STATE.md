...
1. Continue priority-1 primitive work by tightening the next unblocked `avutil-packet` gap, likely packet ABI/field parity or generated oracle fixtures for typed side-data once the pinned FFmpeg 8.1.1 oracle binary is available.
