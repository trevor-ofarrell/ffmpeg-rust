...
1. Commit the coherent `ChannelId` raw ID helper slice.
2. Decide whether the next `avutil-channel-layout` slice should model custom-layout maps or whether another priority-1 infrastructure gap is more urgent.
3. Continue the next unblocked priority-1 infrastructure gap with local unit/fuzz/FATE coverage.

## Known Blockers

- `avutil-channel-layout` now covers local FFmpeg-shaped channel names and native mask helpers for the current subset, including `FLC`, `FRC`, `BC`, `TFL`, `TFC`, `TFR`, `TBL`, `TBC`, `TBR`, `TC`, `DL`, `DR`, `WL`, `WR`, `SDL`, `SDR`, `LFE2`, `TSL`, `TSR`, `BFC`, `BFL`, `BFR`, `SSL`, `SSR`, `TTL`, `TTR`, `BIL`, and `BIR`, plus named `mono`, `stereo`, `2.1`, `3.0`, `3.0(back)`, `4.0`, `quad`, `quad(side)`, `3.1`, `5.0`, `5.0(side)`, `4.1`, `5.1`, `5.1(side)`, `6.0`, `6.0(front)`, `hexagonal`, `6.1`, `6.1(back)`, `6.1(front)`, `7.0`, `7.0(front)`, `7.1`, `7.1(wide)`, `7.1(wide-side)`, `5.1.2`, `5.1.2(back)`, `octagonal`, `cube`, `5.1.4`, `7.1.2`, `7.1.4`, `7.2.3`, `9.1.4`, `9.1.6`, `hexadecagonal`, `binaural`, `downmix`, and `22.2` layouts. `ChannelId` now covers raw native, none, unused, unknown, ambisonic ACN, and user channel IDs. It models FFmpeg default-layout count selection for currently covered first-map entries for counts 1, 2, 3, 4, 5, 6, 7, and 8, but still has no full pinned `ffmpeg -layouts` inventory comparison, no remaining default-layout count table coverage, no custom/native/ambisonic layout order semantics, no upstream FATE parity, and no actual cargo-fuzz execution.
