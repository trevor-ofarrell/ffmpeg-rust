...
1. Continue priority-1 format-model work by choosing the next rawvideo-facing FFmpeg 8.1.1 pixel-format family from pinned inventory/source notes, likely the remaining high-bit YUVA variants after the 8-bit YUVA trio.
