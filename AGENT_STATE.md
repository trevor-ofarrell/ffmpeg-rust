...
1. Continue priority-1 primitive work by tightening the next unblocked avutil surface, likely options edge parity, logging edge parity, or deeper bit I/O vectors, unless a pinned-oracle scaffold becomes available first.
