...
1. Continue priority-1 format-model work by choosing the next rawvideo-facing FFmpeg 8.1.1 pixel-format family from pinned inventory/source notes, likely the remaining rawvideo-facing RGB/YUV/gray/pal/pixel-format gaps now that the NV semi-planar 4:2:2/4:4:4 family is modeled.
