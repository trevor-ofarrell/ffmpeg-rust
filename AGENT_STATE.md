...
1. Continue priority-1 format-model work by choosing the next rawvideo-facing FFmpeg 8.1.1 pixel-format family from pinned inventory/source notes, likely the remaining rawvideo-facing RGB/YUV/gray/pal/pixel-format gaps now that 8-bit and high-bit YUVA are modeled.
