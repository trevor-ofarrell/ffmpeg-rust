...
1. Continue priority-1 primitive work by tightening the next unblocked `avutil-packet` ABI/field-parity gap or move to the next highest-priority unblocked avutil primitive if packet work is blocked on oracle data.
